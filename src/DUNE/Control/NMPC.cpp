...
namespace DUNE{
    namespace Control{
        namespace NMPC{
            ...
            Dynamics::Dynamics(std::string model_type, double Ts, bool compile): Ts_(Ts){
                // get config params
            ...
            std::vector<double> Course::generateRandomVector(int n) {
            ...
            bool Course::updateMpcReference(const double &reference){
            ...
            std::vector<double> Course::reWriteParams(){
            ...
            // allow user to skip configuration
            Course::Course(std::string model_type, std::string cost_type, double Tp, double Ts, bool compile):Dynamics(model_type, Ts, false), Tp_(Tp){
                // set init flag
                initialized_ = -1;
                // set file count flag
                filecount_ = -1;
